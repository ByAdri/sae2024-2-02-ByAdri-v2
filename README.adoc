...
| 1    | link:src/main/java/iut/sae/algo/Algo.java[Algo Simplicité]   | Java     | Simplicité
| 2    | link:src/main/java/iut/sae/algo/Algo1.java[Algo Efficacité]      | Java    | Efficacité
| 3    | link:src/main/java/iut/sae/algo/Algo2.java[Algo Sobriété]       | Java  | Sobriété      
|==========================================================================
...
- Pour exécuter nos codes d'évaluation, assurez-vous d'avoir Java installé sur votre machine. Java est nécessaire pour garantir la compatibilité et la bonne exécution des tests que nous fournissons.

=== Reproductibilité

- Pour reproduire nos analyses :
. Installez Java
. Faites des tests avec des affichages ou des tests JUnit

- Vous pouvez retrouver nos tests ici : link:src/test/java/iut/sae/algo/AlgoTest.java[Test JUnit] 

=== Références

Voici le lien pour pouvoir installer java sur votre machine:

- link:https://www.oracle.com/fr/java/technologies/downloads/[Installer Java]
